...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='organ')
    parser.add_argument('--dataset_path', default='E:\YangHR\oganoid\data', type=str)
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        #     output = model(img)
        # *********************************************************************
        args.lr = 1e-2 * 0.9 ** (epoch - 200)
        args.lr_backbone = 1e-2 * 0.9 ** (epoch - 200)
        if args.distributed:
